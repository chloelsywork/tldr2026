...
//     SCENARIOS                                                                
const SCENARIOS = [
  { id:"S1",  day:1, age:"Age 22", emoji:"  ", tag:"Scenario 1",  title:"Protect Yourself First",
  ...
  { id:"S2",  day:1, age:"Age 24", emoji:" ", tag:"Scenario 2",  title:"Buy Your First Home",
    ...
    choices:[
      ...
      {label:"Buy a Condo", sub:"Higher cost, higher upside   -$80,000", cost:-80000, value:"condo", emoji:"  "}
  ...
  { id:"S7",  day:2, age:"Age 29", emoji:" ", tag:"Scenario 7",  title:"Continue Insurance Premiums?",
    ...
    type:"choice",
    choices:[
      {label:"Keep Paying",   sub:"Stay protected   -$10,000", cost:-10000, value:"cont_insurance",   emoji:"  "},
      {label:"Cancel Policy", sub:"Save the money now",         cost:0,      value:"cancel_insurance", emoji:"  "}
  ...
  { id:"S14", day:3, age:"Age 35", emoji:" ", tag:"Scenario 14", title:"1 in 4: Critical Illness",
    ...
    compute:(d, ciChoice)=>{
      ...
      if (ciChoice==="ci_yes" &&  insured) return {gain:0,       msg:"   CI hit but you're insured   fully covered!",     color:"#4ade80"};
      ...
      <div style={{...card, maxWidth:400, textAlign:"center"}}>
        ...
        <div style={{display:"flex", flexDirection:"column", gap:10}}>
          ...
          <button style={{...btnPrimary, background:"rgba(99,102,241,0.12)", border:"1px solid rgba(99,102,241,0.3)", color:"#a5b4fc"}}
            onClick={()=>setMode("facilitator")}>   Facilitator Panel</button>
        </div>
      </div>
    </div>
  );
        ...
        <div style={{maxWidth:680, width:"100%", display:"flex", flexDirection:"column", gap:10}}>
          ...
          <div style={{...card, padding:"14px 18px"}}>
            <div style={{display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:8}}>
              <div>
                <div style={{color:"#a5b4fc", fontWeight:800, fontSize:12, letterSpacing:1}}>   FACILITATOR PANEL</div>
            ...
            <table style={{width:"100%", borderCollapse:"collapse", fontSize:11}}>
              <thead>
                <tr style={{borderBottom:"1px solid rgba(255,255,255,0.08)"}}>
                  {["Player","Cash","  Property","  ETF","  T-Bills","  Car","   Insured","NAV"].map(h=>(

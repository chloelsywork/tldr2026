...
const SCENE_SVGS = {
  ...
  S6: `<svg viewBox="0 0 380 130" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="105" y="20" text-anchor="middle" fill="#a5b4fc" font-size="10" font-weight="700" font-family="sans-serif">WILL and LPA</text>
    <!-- family silhouettes -->
  ...
  S8: `<svg viewBox="0 0 380 130" xmlns="http://www.w3.org/2000/svg">
    ...
    <text x="60" y="108" text-anchor="middle" fill="#94a3b8" font-size="9" font-family="sans-serif">angpaos dont cover it!</text>
  </svg>`,
